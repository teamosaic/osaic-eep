...
export const identityProvider = new IdentityProvider({
  sso_login_url: process.env.SITE == 'prod' ? "https://www.v2020.com/sso/eep/eepConnect.aspx" : "https://agqa.v2020.com/sso/eep/eepConnect.aspx",
    certificates: [
      fs.readFileSync(path.join(certsDirectory, process.env.SITE == 'prod' ? "idp_key.pem" : 'idp_uat_key.pem')).toString()
    ]
})
