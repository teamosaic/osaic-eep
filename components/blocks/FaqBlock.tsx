...
export default function FaqBlock({
  ...
  return (
    <div className="max-w-screen-lg mx-auto px-gutter">
      <div className="divide-y divide-blend-10">
        ...
        {/* FAQ listing */}
        <dl className="mt-10f space-y-6f divide-y divide-blend-10">
          {(faqs || []).map((faq) => (
...
function FaqAccordion({ question, answer }: Faq): ReactElement {
  return (
    <Disclosure as="div" className="pt-6f">
      {({ open }) => (
        <>
          ...
          <dt>
            <Disclosure.Button
              ...
              <span className="font-medium leading-7 text-left">
                {question}
              </span>
          ...
          {/* Collapsable answer */}
          <Disclosure.Panel as="dd" className="mt-4f pr-12f">
